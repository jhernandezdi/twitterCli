...
@SuppressWarnings("unused")
 public class HashtagsCritPaged extends HashtagsCrit implements Pageable, Serializable {
   ...
   private Sort sort;
	...
	{
		return "HashtagsCritPaged{ "+super.toString()+
			", Pageable{" +
	...
	public HashtagsCritPaged()
	{
		super();
	}
	
	public HashtagsCrit getCrit()
	{
		return this;
	}
