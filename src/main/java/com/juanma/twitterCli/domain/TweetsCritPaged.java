...
@SuppressWarnings("unused")
 public class TweetsCritPaged extends TweetsCrit implements Pageable, Serializable {
   ...
   private Sort sort;
	...
	{
		return "TweetsCritPaged{ "+super.toString()+
			", Pageable{" +
	...
	public TweetsCritPaged()
	{
		super();
	}
	
	public TweetsCrit getCrit()
	{
		return this;
	}
